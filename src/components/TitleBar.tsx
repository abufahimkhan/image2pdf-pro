...
export default function TitleBar({ onShowAbout, onShowHistory }: { onShowAbout: () => void; onShowHistory: () => void }) {
  ...
  return (
    <header className="h-14 border-b border-slate-200/80 dark:border-[#27272a] bg-white dark:bg-[#09090b] backdrop-blur-md px-6 flex items-center justify-between sticky top-0 z-30 select-none">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-slate-800 dark:text-[#fafafa] tracking-tight text-sm">Image2PDF Pro</span>
          <span className="text-[10px] select-none uppercase font-bold tracking-widest bg-indigo-50 dark:bg-[#18181b] text-indigo-600 dark:text-[#a1a1aa] px-1.5 py-0.5 rounded border border-indigo-100 dark:border-[#27272a]">
            Document
          </span>
        </div>
      </div>
